			...
			callback: async (event) => {
				if (event.options.power === 'powerOn') {
					...
					if (!macAddress || macAddress === "") {
						console.error('Unable to turn on the TV without a macAddress. Turn on the TV first then connect to automatically get the macAddress.')
						return
					}
